...
class TestFileLoader(unittest.TestCase):
    ...
    def test_pdf_file_format(self):
        self.assertTrue(validate_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/somatosensory.pdf"))

    def test_docx_file_format(self):
        self.assertTrue(validate_docx("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/file-sample_100kB.docx"))

    def test_ppt_file_format(self):
        self.assertTrue(validate_ppt("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/sample1.pptx"))

    def test_file_size_limit(self):
        self.assertTrue(check_file_size("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/somatosensory.pdf"))
...
class TestPDFExtraction(unittest.TestCase):
    ...
    def test_pdf_text_extraction(self):
        self.assertEqual(extract_text_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/somatosensory.pdf"), ["sample text"])

    def test_pdf_image_extraction(self):
        self.assertEqual(extract_images_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/somatosensory.pdf"), ["image"])

    def test_pdf_link_extraction(self):
        self.assertEqual(extract_links_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/somatosensory.pdf"), ["http://example.com"])

    def test_pdf_table_extraction(self):
        self.assertEqual(extract_tables_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/somatosensory.pdf"), [["Table data"]])
...
class TestDOCXExtraction(unittest.TestCase):
    ...
    def test_docx_text_extraction(self):
        self.assertEqual(extract_text_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/file-sample_100kB.docx"), ["sample text"])

    def test_docx_image_extraction(self):
        self.assertEqual(extract_images_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/file-sample_100kB.docx"), ["image"])

    def test_docx_link_extraction(self):
        self.assertEqual(extract_links_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/file-sample_100kB.docx"), ["http://example.com"])

    def test_docx_table_extraction(self):
        self.assertEqual(extract_tables_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/file-sample_100kB.docx"), [["Table data"]])
...
class TestPPTExtraction(unittest.TestCase):
    ...
    def test_ppt_text_extraction(self):
        self.assertEqual(extract_text_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/sample1.pptx"), ["sample text"])

    def test_ppt_image_extraction(self):
        self.assertEqual(extract_images_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/sample1.pptx"), ["image"])

    def test_ppt_link_extraction(self):
        self.assertEqual(extract_links_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/sample1.pptx"), ["http://example.com"])

    def test_ppt_table_extraction(self):
        self.assertEqual(extract_tables_from_pdf("/home/shtlp_0010/Desktop/Assignment_File_Extraction/Samples/sample1.pptx"), [["Table data"]])
